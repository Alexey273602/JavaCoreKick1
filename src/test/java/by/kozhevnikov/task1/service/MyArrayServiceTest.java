...
public class MyArrayServiceTest {
  ...
  @Test
  public void testSum() {
    MyArray array = ArrayFactoryImpl.createArray(new int[]{1, 2, 3, 4});
  ...
  public void testMinMax() {
    MyArray array = ArrayFactoryImpl.createArray(new int[]{5, 2, 9, 1});
  ...
  public void testInsertionSortFunctional() {
    MyArray array = ArrayFactoryImpl.createArray(new int[]{4, 1, 3, 2});
